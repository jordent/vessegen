...
def add_media_to_single_reservoir(chamber_id, window, led, start_time):
    ...
    layout = [
        ...
        [sg.Button("-0.1", button_color='red', font='Roboto 15', pad=(5, 5)),
         sg.Button("+0.1", button_color='red', font='Roboto 15', pad=(5, 5))],
        [sg.Button("-1", button_color='red', font='Roboto 15', pad=(5, 5)),
         sg.Button("+1", button_color='red', font='Roboto 15', pad=(5, 5))],
        [sg.Button("-5", button_color='red', font='Roboto 15', pad=(5, 5)),
         sg.Button("+5", button_color='red', font='Roboto 15', pad=(5, 5))],
        [sg.Button("-10", button_color='red', font='Roboto 15', pad=(5, 5)),
         sg.Button("+10", button_color='red', font='Roboto 15', pad=(5, 5))],
